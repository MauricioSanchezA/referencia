<?php
    ...
    if(verificar_datos("[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{4,50}",$nombre)){
        echo '
            <div class="notification is-danger is-light">
                <strong>¡Ocurrio un error inesperado!</strong><br>
                El NOMBRE DE LA ESPECIALIDAD no coincide con el formato solicitado
            </div>
        ';
        exit();
    }
    ...
    if($ubicacion!=""){
    	if(verificar_datos("[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{5,150}",$ubicacion)){
	        echo '
	            <div class="notification is-danger is-light">
	                <strong>¡Ocurrio un error inesperado!</strong><br>
	                La UBICACION DE LA ESPECIALIDAD no coincide con el formato solicitado
	            </div>
	        ';
	        exit();
	    }
    ...
    /*if($nombre!=$datos['categoria_nombre']){
	    ...
	    if($check_nombre->rowCount()>0){
	        echo '
	            <div class="notification is-danger is-light">
	                <strong>¡Ocurrio un error inesperado!</strong><br>
	                El NOMBRE DE LA ESPECIALIDAD ingresada ya se encuentra registrado, por favor elija otro
	            </div>
	        ';
	        exit();
	    }
    ...
    if($actualizar_categoria->execute($marcadores)){
        echo '
            <div class="notification is-info is-light">
                ...
                La especialidad se actualizo con exito
            </div>
        ';
    }else{
        echo '
            <div class="notification is-danger is-light">
                <strong>¡Ocurrio un error inesperado!</strong><br>
                No se pudo actualizar la Especialidad, por favor intente nuevamente
            </div>
        ';
    }
